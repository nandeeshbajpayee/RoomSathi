...
const Footer = () => {
    return (
        <>
            <footer className="relative z-10 bg-slate-100 pt-20 pb-10 lg:pt-[120px] lg:pb-20 flex justify-center items-center">
                    ...
                    <div className="flex flex-wrap -mx-4">
                        <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
                            <div className="w-full mb-10">
                                ...
                                <p className="text-base mb-7 text-body-color text-neutral-700">
                                    F Block ,GLA University,17km Stone, NH-2, Mathura-Delhi Road Mathura, Chaumuhan, Uttar Pradesh 281406
                                </p>
                        ...
                        <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
                            <div className="w-full mb-10">
                                ...
                                <div className="flex items-center mb-6">
                                    <a
                                        href="/#"
                                        className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:border-primary hover:bg-primary hover:text-orange-400 sm:mr-4 lg:mr-3 xl:mr-4"
                                    >
                                        <svg
                                            width={8}
                                            height={16}
                                ...
                                <p className="text-base text-body-color">
                                    {" "}
                                    © {new Date().getFullYear()} RoomSathi{" "}
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    return (
        <>
            <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
                <div className="w-full mb-10">
                    <h4 className="text-lg font-semibold mb-9 text-neutral-700"> {header} </h4>
                    <ul>{children}</ul>
                </div>
            </div>
        </>
    ...
    return (
        <div>
            <li>
                <a
                    href={link}
                    className={`inline-block mb-2 text-base leading-loose text-body-color text-neutral-700 hover:text-orange-400`}
                >
                    {label}
                </a>
            </li>
